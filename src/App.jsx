...
import EdmondsKarpInfo from "./pages/learn/EdmondsKarpInfo";
import BoykovKolmogorovInfo from "./pages/learn/BoykovKolmogorovInfo";
// --- END KEY CHANGES ---
      ...
      <main className="content-area">
        <Routes>
          ...
          <Route path="/learn" element={<LearnPage />}>
            ...
            <Route path="edmonds-karp" element={<EdmondsKarpInfo />} />
            <Route
              path="boykov-kolmogorov"
              element={<BoykovKolmogorovInfo />}
            />
          </Route>
          {/* --- END KEY CHANGE --- */}
        </Routes>
